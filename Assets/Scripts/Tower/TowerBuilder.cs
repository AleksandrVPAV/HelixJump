...
public class TowerBuilder : MonoBehaviour
{
    ...
    [SerializeField] private Platform _spawnPlatform;
    [SerializeField] private FinishPlatform _finishPlatform;
    [SerializeField] private Platform[] _platform;        

    private float _startAndFinishAdditioinalScale = 0.5f;   
    public float BeamScaleY => _levelCount / 2f + _startAndFinishAdditioinalScale;             
